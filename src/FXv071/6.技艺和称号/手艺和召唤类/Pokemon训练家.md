...
<br>
<br>每当你在操纵神奇宝贝战斗的时候，对任何第二档不良状态都具有2点免疫。（第二档不良状态：除了目眩、耳鸣、疲乏、亢奋、肢体妨碍的所有不良状态） 
<br>
<br>=========================================================== 
<br>A级：精英训练师 
<br>
...
<br>
<br>如果你这一击的伤害值造成的恶性伤害不足以填满对方的生命值。则该生物会在你的回合结束时从精灵球中放出，并回到原本位置，状态和收入精灵球前一样。 
<br>
...
<br>一回合一次，你和神奇宝贝可以同时为神奇宝贝的一次行动（非延长动作且只需一次判定）以一个自由动作花费1点意志力，在该行动上获得＋6DP的表现加值（本加值可与其他同类型加值叠加），这种用法对一次行动只能使用一次。或者在战斗时同时以反射动作花费1意志力，在防御上获得＋4表现加值，持续一轮。
<br>这视作一次对一只神奇宝贝的指挥。
<br>
<br>灵活闪躲 C+1000 
<br>并不是每场战斗都是公平对战，很多时候训练家需要在指挥神奇宝贝的同时保护自身的安全，躲避战斗的余波甚至是直接针对训练家的攻击。 
<br>以一个移动动作使用并维持，你在防御上额外获得你的【运动技能+反射专业等级】/2+4的闪避加值，同时你的反射豁免额外获得4DP技艺加值。 
<br>在使用或维持这个技艺时，你不能进行格挡。 
<br>该技能可进行差价升级 
<br>灵活闪躲 B+2000 
<br>以一个移动动作使用并维持，你在防御上额外获得你的【运动技能+反射专业等级】/2+8的闪避加值，同时你的反射豁免额外获得8DP技艺加值，视作拥有B级防措手不及。 
<br>
<br>规避指令 C+1000
<br>下达规避的指令，使神奇宝贝即使仍站在原地也能闪避对方的攻击。
<br>以一个自由动作使用，这视作一次指挥。神奇宝贝将消耗一个移动动作，在这回合中神奇宝贝的防御上获得等于其【运动技能+闪避专业等级】/2的闪避加值。
<br>
<br>根性燃烧 C+1000
<br>燃烧神奇宝贝的热血，使神奇宝贝即使受到了严重的伤害也不会轻易倒下。
<br>一场景一次，以一个移动动作使用，这视作一次对一只神奇宝贝的指挥。在本场景中，该神奇宝贝不会因为生命值被严重伤害填满而昏迷。
<br>额外支付C+1250，该技能的使用动作降至自由动作，并且不再限制一场景一次。
<br>
<br>闪避指令 C+1250 
<br>在对方进行攻击前下令，让神奇宝贝紧急规避对方的攻击。 
<br>以一个反射动作使用，这视作一次对一只神奇宝贝的指挥。你所指挥的神奇宝贝可以立刻以一个反射动作移动最多5米的距离。 
<br>“皮卡丘快躲开！” 
<br>该技能可进行差价升级 
<br>闪避指令 CC+2000 
<br>升级后的闪避指令有两种用法，一回合只能使用其中一种。 
<br>1、以一个反射动作使用，这视作一次对一只神奇宝贝的指挥。你所指挥的神奇宝贝可以立刻以一个反射动作移动最多等于一半的基本速度的距离。 
<br>2、以一个反射动作使用，这视作一次对神奇宝贝的指挥。你所指挥的神奇宝贝（可复数）可以立刻以一个反射动作移动最多5米的距离。 
<br>
<br>配合攻击 C+1500 
<br>通过镶嵌精灵球的武器或道具，使得精灵在球内就与训练家完成协同攻击，训练家（对空气）使用一个至少为标准动作的C级或以下的攻击招式后，精灵自动脱离精灵球（精灵被释放的地点视作你已将精灵球投掷出去判断），并立刻发动预先设定的攻击，在此次攻击中精灵额外获得训练家使用招式的效果。同时这次攻击视作进行了一次虚招检定，虚招获得的加成由精灵的这次攻击获得。 
<br>ST需要判断训练家所使用的招式和招式的效果是否能够被精灵所获得。比如镶嵌了精灵球的法杖或枪支使用的法术或招式都不能被精灵所获得，物理类的效果比如破甲、高速、直接给攻击+xdp等都可获得，超自然类的效果比如不打正常防御打强韧豁免、扣除对面能量、造成属性伤害、造成缠绕不良点数等都无法获得。 
<br>因使用此方式释放的神奇宝贝的先攻顺序自动排至训练师之后，每次只能用此方式释放1只神奇宝贝。 
<br>范例：人物使用镶嵌了精灵球的双截棍进行全力攻击（对空气），同时大岩蛇从精灵球中被释放使用火箭头槌，这次火箭头槌获得攻击+2DP，大岩蛇的基本防御-2DP。 
<br>
<br>护主 CC+1500
<br>在训练家受到对方无耻的攻击时，神奇宝贝就会挺身而出为训练家挡下攻击。
<br>当训练家受到他人攻击时，训练家附近的一只神奇宝贝可立刻移动到训练家身旁，为训练家提供全掩蔽，任何原本朝攻击训练家的攻击都会改为攻击那只神奇宝贝。该技能的效果持续一回合。
<br>触发此技能时，该神奇宝贝需要距离训练家移动速度一半的距离（神奇宝贝的移动速度）内。
<br>在使用此技能后，神奇宝贝将失去下回合的一个标准动作。
<br>
<br>联防 B+2000
<br>所谓联防，就是联合防御，即在属性不利的情况下尽可能更换属性有利的神奇宝贝上场以减最近的意志少伤害。
<br>一回合一次，当对方对你的一只神奇宝贝进行攻击时，以一个反射动作使用，将场上那只神奇宝贝收回，并将另一只神奇宝贝释放到被收回的神奇宝贝的位置。被替换上场的神奇宝贝将承受这次攻击，并且在替换上场的神奇宝贝在这回合中没有动作（但保有正常防御），直到下回合开始时才投掷先攻，按先攻顺序开始行动。
<br>
<br>战术指令 B+2500 
<br>需求：智力11+ 
<br>该技能可以在C级攻击指令和防御指令的基础上差价升级 
<br>通过详细分析对方的行动和情报，下达准确的指令，使神奇宝贝能给与对方的弱点以精确的打击。 
<br>以一个标准动作使用，这视作一次指挥，同时你需要投掷一次动物沟通检定（纯专业检定）。你所指挥的神奇宝贝（可复数）在这一轮中攻击和防御额外获得检定成功数+16点洞察加值。 
<br>该技能可进行差价升级 
<br>战术指令 A+6000 
<br>投掷的检定改为操控/智力（取高）+求生+动物沟通检定。你所指挥的神奇宝贝（可复数）在这一轮中攻击和防御额外获得检定成功数+12点洞察加值。 
<br>
<br>鼓舞指令 B+2500 
<br>需求：风度/操控11+ 
<br>该技能可以在C级攻击指令和防御指令的基础上差价升级 
<br>尽管下达的指令并不是很详细，但是一言一语中都蕴含着训练家的热情，这些热情的话语将会为神奇宝贝战斗的动力。 
<br>以一个标准动作使用，这视作一次指挥，同时你需要投掷一次动物沟通检定（纯专业检定）。你所指挥的神奇宝贝（可复数）在这一轮中攻击和防御额外获得检定成功数+16点士气加值。 
<br>该技能可进行差价升级 
<br>鼓舞指令 A+6000 
